...
<template>
  <div class="bg-white rounded-lg shadow-lg max-w-sm w-full md:w-1/2 lg:w-1/3 m-4 overflow-hidden">
    ...
    <p class="mx-4 mt-2 mb-4 text-gray-600">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod
      tempor
      incididunt ut labore et dolore
      magna aliqua. Eget aliquet nibh praesent tristique magna. At elementum eu facilisis sed odio.</p>
  </div>
</template>
