...
<template>
  <div class="flex items-center py-4 border-b border-gray-200">
    <div
      class="w-20 bg-cover rounded-lg aspect-square"
    ...
    <div class="flex-1 mx-6">
      ...
      <h4 class="mt-1 text-sm text-gray-800">
        Stückpreis: {{ item.product.price }}
      </h4>
    </div>
    <div>
      ...
      <div class="flex items-center">
        ...
        <mdicon
          name="trash-can"
          @click="cart.removeAllOfProduct(item.product)"
