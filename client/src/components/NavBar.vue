...
<template>
  <nav class="fixed top-0 left-0 right-0 z-50 grid w-full h-20 grid-cols-3 p-4 bg-white shadow-md lg:px-12">
    <div class="flex items-center justify-center w-full h-full col-start-2">
      <router-link to="/">
